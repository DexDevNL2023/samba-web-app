...
export default class PasswordComponent implements OnInit {
  ...
  changePassword(): void {
    ...
    const form: ChangePasswordRequest = this.passwordForm.value; // Récupère les valeurs des champs du formulaire
    ...
    if (form.newPassword !== form.confirmPassword) {
      ...
      this.accountCrudService.changePassword(form).subscribe({
        next: () => {
