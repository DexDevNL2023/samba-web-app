export interface Subfield {
  ...
  values?: any[] | any;     // tableau de données : Liste optionnelle de valeurs pour le sous-champ
  ...
  control?: (item: any[] | any, event: any) => void;  // item etant l'objet parent, Méthode à exécuter lors du changement de valeur d'un sous-champ
