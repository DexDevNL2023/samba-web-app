...
export class ContratAssuranceCrudComponent implements OnInit {
  ...
  selectedItem: ContratAssurance; // Élément de type ContratAssurance actuellement sélectionné ou en cours de modification
  selectedItems: ContratAssurance[] = []; // Tableau d'éléments de type ContratAssurance sélectionnés
  ...
  branches: EntityByBranch<ContratAssurance>[] = [
      {
          name: 'Branch A',
          partenaires: [
              {
  ...
  constructor(
    ...
    private service: ContratAssuranceService, // Service pour les opérations CRUD génériques
  ...
  protected calculateTotalSubscriptions(branch: EntityByBranch<ContratAssurance>): number {
  ...
  protected openNew() {
    this.selectedItem = {} as ContratAssurance; // Initialise un nouvel élément
  ...
  protected editItem(item: ContratAssurance) {
  ...
  protected deleteItem(item: ContratAssurance) {
  ...
  protected confirmDelete() {
    ...
    this.service.delete((this.selectedItem as any).id).subscribe(() => { // Supprime l'élément via le service
      ...
      this.selectedItem = {} as ContratAssurance; // Réinitialise l'élément
    });
  }
