...
export class SouscriptionCrudComponent implements OnInit {
  ...
  cols: Column[] = [
    ...
    { field: 'polices', header: 'Polices d\'souscription', type: 'list', values: [], label: 'numeroPolice', key: 'id', subfield: [
        { field: 'id', header: 'ID', type: 'id' },
  ...
  items: Souscription[] = [
    ...
    {
      id: 1,
      nom: 'Souscription Maladie Complémentaire',
    ...
    {
      id: 2,
      nom: 'Souscription Hospitalisation',
      description: 'Prise en charge des frais d\'hospitalisation en cas de maladie ou d\'accident.',
      type: InsuranceType.SANTE,
      polices: [2]
    },
  
    // Souscriptions Automobile
    {
      id: 3,
      nom: 'Souscription Responsabilité Civile Auto',
  ...
  polices: PoliceSouscription[] = [
    // Polices pour Souscription Santé
    {
      id: 1,
      numeroPolice: 'S001',
      label: 'Police Souscription Maladie Complémentaire',
    ...
    },
    {
      id: 2,
      numeroPolice: 'S002',
      label: 'Police Souscription Hospitalisation',
    ...
    // Polices pour Souscription Automobile
    {
      id: 3,
      numeroPolice: 'A001',
    ...
    // Polices pour Souscription Agricole
    {
      id: 5,
      numeroPolice: 'AG001',
      label: 'Police Souscription Récoltes',
    ...
    },
    {
      id: 6,
      numeroPolice: 'AG002',
      label: 'Police Souscription Bétail',
    ...
    // Polices pour Souscription Personne
    {
      id: 7,
      numeroPolice: 'P001',
      label: 'Police Souscription Vie',
    ...
    },
    {
      id: 8,
      numeroPolice: 'P002',
      label: 'Police Souscription Invalidité',
  ...
  loadPolices(): void {
    this.service.getAllPolices().subscribe((polices: PoliceSouscription[]) => {
